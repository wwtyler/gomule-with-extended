...
public class D2SharedStashTest {
    ...
    public void testConstruction() {
        ...
        expectedGrid[0][0] = items.getFirst();
        expectedGrid[1][0] = items.getFirst();
        expectedGrid[2][0] = items.getFirst();
        expectedGrid[3][0] = items.getFirst();
        expectedGrid[4][0] = items.getFirst();
        expectedGrid[0][1] = items.getFirst();
        expectedGrid[1][1] = items.getFirst();
        expectedGrid[2][1] = items.getFirst();
        expectedGrid[3][1] = items.getFirst();
        expectedGrid[4][1] = items.getFirst();
        expectedGrid[0][2] = items.getFirst();
        expectedGrid[1][2] = items.getFirst();
        expectedGrid[2][2] = items.getFirst();
        expectedGrid[3][2] = items.getFirst();
        expectedGrid[4][2] = items.getFirst();
        expectedGrid[0][3] = items.getFirst();
        expectedGrid[1][3] = items.getFirst();
        expectedGrid[2][3] = items.getFirst();
        expectedGrid[3][3] = items.getFirst();
        expectedGrid[4][3] = items.getFirst();
        expectedGrid[0][4] = items.getFirst();
        expectedGrid[1][4] = items.getFirst();
        expectedGrid[2][4] = items.getFirst();
        expectedGrid[3][4] = items.getFirst();
        expectedGrid[4][4] = items.getFirst();
        expectedGrid[15][12] = items.get(1);
    ...
    public void getItemCovering() {
        ...
        assertEquals(items.getFirst(), d2SharedStashPane.getItemCovering(0, 0));
        assertEquals(items.getFirst(), d2SharedStashPane.getItemCovering(4, 4));
